    ...
    def step(self, selected):
        ...
        if done:
            ...
            for element in soln0:
                if element == 0:
                    soln0_path.append(self.dxy_0[0].cpu())  # Add the value from self.dxy[0] if the element is 0
                else:
                    soln0_path.append(self.nxy_0[element - 1].cpu())  # Add the value from self.nxy[element-1] otherwise
            print (soln0_path)
        else:
            reward = None
