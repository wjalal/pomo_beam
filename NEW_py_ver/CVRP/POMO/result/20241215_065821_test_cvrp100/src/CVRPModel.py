    ...
    def forward(self, state):
        ...
        if state.selected_count == 0:  # First Move, depot
            ...
            for k in range(beam_size):
                ...
                logprob.append(state.logprob[:,:,k,None] + torch.log(topk_probs))
            ...
            _, selected = logprob.topk(beam_size, dim=2)
            selected_beams = selected // beam_size
            prob = prob.gather(2, selected)
